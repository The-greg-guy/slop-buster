...
name: design-slop
version: 1.0.0
description: Identify and eliminate AI design slop. Fonts, colors, layout, motion, content. Loaded as a peer to text-slop and ponytail within Stop Slop Ultimate.
metadata:
...
Slop is what happens when an AI falls back on statistical averages. Inter as the default font. Lavender-purple as the default accent. Centered hero with a badge above the H1. Identical feature cards in a 3 by 2 grid. "Trusted by" grayscale logo strips. 3-tier pricing with a "Most Popular" badge. The output looks like every other AI-generated page. If you reach for Inter without a reason, you have no point of view. Pick again.
...
- [ ] Aurora or mesh gradient background? Remove unless it encodes data.
...
- [ ] "Trusted by" grayscale logo strip? Cut unless every logo links to a case study.
- [ ] 3-tier pricing with "Most Popular" badge? Cut the badge unless it encodes real data.
- [ ] FAQ accordion before footer? Move to a real help page.
...
- [ ] Scroll-jacking? Remove. Let the user control scroll.
- [ ] Custom cursor? Remove unless it is the product.
...
- [ ] Fake 5-star review count? Remove or verify.
- [ ] AI-generated stock imagery? Use real photos or nothing.
- [ ] Section label restates the heading? Make every word earn its place.
- [ ] "Trusted by 10,000+ companies" with no linkable logos? Cut the claim.
- [ ] Rocket emoji in the hero? Cut it.
...
These patterns are slop by default. The exceptions below exist for cases where the pattern is the right choice and you can defend it. If you cannot defend the choice in one sentence, the pattern stays slop. When in doubt, cut it.
...
- **Stat banner.** Defense required: "Every number is verifiable, sourced, and current."
...
- **All-caps short label.** Defense required: "Two to three words, used as a category tag, with open letter-spacing."
...
- **"Trusted by" logo strip.** Defense required: "Every logo links to a real, verifiable case study." A grayscale strip of logos with no links is slop regardless of who the logos are.
- **3-tier pricing.** Defense required: "The tiers reflect real usage patterns and the differentiation is honest." Three tiers that are "more of everything" do not qualify.
- **FAQ accordion.** Defense required: "The accordion is the right progressive disclosure pattern for the content." Most FAQ accordions belong on a help page.
- **Custom cursor.** Defense required: "The cursor is part of the product." Design tools, drawing apps. Marketing pages do not qualify.
- **Scroll-jacking.** Defense required: "The scroll behavior is the product." Immersive story experiences. Marketing pages do not qualify.
